# Generated by Django 3.1 on 2020-10-03 15:07
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.FloatField(verbose_name='phone_number')),
                ('national_id', models.FloatField(unique=True, verbose_name='national_id')),
                ('gender', models.CharField(choices=[('Male', 'Male'), ('Female', 'Female')], max_length=255, verbose_name='gender')),
                ('year', models.CharField(choices=[('1', '1'), ('2', '2'), ('3', '3')], max_length=255, verbose_name='year')),
                ('is_student', models.BooleanField(default=True, verbose_name='is_student')),
                ('is_publisher', models.BooleanField(default=False, verbose_name='is_publisher')),
